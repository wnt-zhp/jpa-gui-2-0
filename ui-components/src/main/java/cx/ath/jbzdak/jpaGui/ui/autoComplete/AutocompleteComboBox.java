...
public class AutocompleteComboBox<V> extends JComboBox {
   ...
   private boolean selectedItemFromModel;
   ...
   public boolean isSelectedItemFromModel() {
      return selectedItemFromModel;
   }

   public void setSelectedItemFromModel(boolean selectedItemFromModel) {
      boolean oldSelectedItemFromModel = this.selectedItemFromModel;
      this.selectedItemFromModel = selectedItemFromModel;
      firePropertyChange("selectedItemFromModel", oldSelectedItemFromModel, this.selectedItemFromModel);
   }
   ...
   public void setSelectedItem(Object anObject) {
      ...
      setSelectedItemFromModel(isFromModel);
